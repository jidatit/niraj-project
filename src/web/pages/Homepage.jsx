    ...
    <>
      ...
      >
        <div className='w-[90%] md:w-[60%] z-[10] md:absolute left-5 md:ml-[60px] gap-5 flex flex-col justify-center items-start'>
          <h1 className='font-bold text-[22px] md:text-[50px] text-start md:text-left'>
          ...
          <div className='w-full flex flex-col md:flex-row justify-center md:justify-start items-center gap-5'>
            <Link to="/auth"><button className='bg-[#003049] rounded-[32px] py-1 font-semibold px-6 text-white text-[18px] lg:text-[28px]'>Get Free Quote</button></Link>
            <Link to="/auth/signup"><button className='bg-[#D62828] rounded-[32px] text-[18px] py-1 font-semibold px-[53px] text-white lg:text-[28px]'>Register</button></Link>
          </div>
        </div>
      ...
      >
        ...
        <div className='w-[60%] flex md:flex-row flex-col justify-center items-center gap-5'>
          <Link to="/auth"><button className='bg-[#003049] rounded-[32px] py-1 font-semibold px-6 text-white text-[18px] md:text-[28px]'>Get Free Quote</button></Link>
          <Link to="/auth/signup"><button className='bg-[#D62828] rounded-[32px] text-[18px] py-1 font-semibold px-[53px] text-white md:text-[28px]'>Register</button></Link>
        </div>
      </div>
