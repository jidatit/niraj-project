        ...
        <>
            <nav className="bg-white border-gray-200">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <img src={logo} className="w-[221px] h-[139px]" alt="Flowbite Logo" />
                    ...
                    <div className={`w-full md:flex md:w-auto ${isMenuOpen ? "" : "hidden"}`} id="navbar-default">
                        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-white md:flex-row lg:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white">
                            <li>
                                <a href="#" className="block py-2 px-2 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 text-black">Home</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-2 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 text-black">Resource Center</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-2 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 text-black">Testimonials</a>
                            </li>
                            <li>
