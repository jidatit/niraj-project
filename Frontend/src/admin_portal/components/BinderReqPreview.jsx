...
import { Modal, Slide, TextField, FormControl, InputLabel, Select, MenuItem } from '@mui/material'
            ...
            >
                ...
                >
                    ...
                    <div className='w-[95%] overflow-y-auto max-h-[80vh] lg:w-[50%] p-10 lg:p-20 bg-white flex flex-col justify-start items-center rounded-lg shadow-md'>
                        ...
                        {data && (<div className='w-full flex flex-col justify-center items-center md:items-start'>
                            <h1 className='lg:text-[32px] md:text-start text-center font-bold md:text-[24px] text-[18px]'>Binder Form for {data.qsr_type} Quote</h1>
                        </div>)}
