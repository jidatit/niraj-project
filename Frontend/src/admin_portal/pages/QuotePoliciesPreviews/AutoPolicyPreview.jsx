        ...
        <div className="md:w-[50%] w-[90%] gap-4 bg-white flex flex-col rounded-md shadow-lg overflow-y-auto max-h-[80vh] items-center py-[30px] px-[60px]">
          ...
          <div className='w-full flex mt-[10px] flex-col justify-start items-start'>
            <button
              ...
              type="button"
            >Policy Type: ( Auto )</button>
            <h1 className='font-bold mt-[20px] lg:text-[25px]'>Form for Auto Quote</h1>
          </div>
          ...
          {property_damage && renderTextField("Property Damage", property_damage)}
          {bodily_injury_limit && renderTextField("Bodily Injury Limit", bodily_injury_limit)}
          {collision_deductible && renderTextField("Collision Deductible", collision_deductible)}
          {comprehensive_deductible && renderTextField("Comprehensive Deductible", comprehensive_deductible)}
