...
const PolicyDetailsModal = ({ open, onClose, selectedRow }) => {
  ...
  return (
    ...
    >
      {selectedRow?.isRenewal ? (
        // — Renewal case: show empty state
        <div className="bg-white p-8 rounded-md shadow-lg flex flex-col items-center">
          <EmptyState
            message="This is a renewal quote—there’s no form data to display."
            icon="sad"
          />
        </div>
      ) : (
