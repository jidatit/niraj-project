...
const PolicyQuoteProgress = () => {
  ...
  const currentStep =
    QuoteDetails && QuoteDetails.status === "completed"
      ? parseInt(QuoteDetails.status_step)
      : null;
  ...
  const progressCardData = [
    {
      ...
      image: reqicon,
      info: "Your Quote has been Successfully Requested",
    },
    {
      heading: "Quote in progress",
      image: progicon,
      info: "Your Quote is Currently in Progress",
    },
    {
      heading: "Quote delivered",
      image: delicon,
      info: "Your Quote has been Successfully Delivered",
    },
    {
      heading: "Binder Requested",
      image: reqicon,
      info: "Binder has been Successfully Requested",
    },
    { heading: "Active Policies", image: boundicon, info: "Policy Bound" },
  ];

  const filteredProgressCardData =
    currentStep !== null ? progressCardData.slice(0, currentStep + 1) : [];
    ...
    <>
      <div className="w-full flex flex-col bg-[#FAFAFA] justify-center items-center">
        ...
        {loading ? (
          ...
          <ProgressCard
            heading="Quote Request Not Started"
            image={reqicon}
            info="Awaiting Inspections. No inspections added yet."
          />
        )}
      </div>
    </>
...
const ProgressCard = ({ heading, image, info }) => {
  return (
    <div className="w-full mt-[30px] mb-[30px] flex flex-col justify-center items-center gap-5">
      <p className="text-start w-full px-2 md:px-20 lg:text-[28px] md:text-[23px] text-[18px] font-bold">
        {heading}
      </p>
