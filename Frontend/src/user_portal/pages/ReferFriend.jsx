...
const ReferFriend = () => {
  ...
  const sendEmail = (event) => {
    ...
    const templateParams = {
      ...
      link: `${
        import.meta.env.VITE_BUTTON_LINK
      }?name=${name_fi}&email=${email_fi}&phoneNumber=${phoneNumber_fi}`,
    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_EMAILJS_REFER_TEMPLATE_ID,
        templateParams,
