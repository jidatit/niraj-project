...
const ForgotPasswordReferral = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!userData || userData.signupType !== "Referral") {
        toast.error("This email is not registered as a referral.");
        return;
      }
      await sendPasswordResetEmail(auth, email);
      toast.success("Check your email account for reset instructions.");
      setTimeout(() => {
        navigate("/auth/login_referral");
      }, 5000);
    } catch (err) {
...
export default ForgotPasswordReferral;
